...
class LLMHandler:
    ...
    def get_model_name(self, friendly_name: str) -> str:
        """Converts user-friendly model name to the official API model name."""
        model_map = {
            "Gemini Pro": "gemini-1.5-pro",
            "Gemini Pro Vision": "gemini-pro-vision",
            # GPT-4 would require a different handler, but we can map it for now
            "GPT-4": "gemini-1.5-pro"
        }
        return model_map.get(friendly_name, "gemini-1.5-pro")
